					...
					<div id="sidebar" class="well sidebar span3">
						<div class="row">
							<div id="organization-info" class="span3">
								<legend>Information<a class="oai-action" target="_blank" style="float: right" title=""""),_display_(Seq[Any](/*51.95*/project/*51.102*/.getTitle())),format.raw/*51.113*/(""" OAI url for ese namespace" href='"""),_display_(Seq[Any](/*51.148*/project/*51.155*/.getOAIUrl("ese"))),format.raw/*51.172*/("""'></a></legend>
...
"""))}
    ...
    def ref = this
                ...
                /*
                    -- GENERATED --
                    DATE: Mon Mar 16 13:57:16 EET 2015
                    SOURCE: /home/costas/toplay/mintoai/Application/app/views/organization.scala.html
                    HASH: 8b22e520da2e373bbbac0c57f83431dfbb1d01a1
